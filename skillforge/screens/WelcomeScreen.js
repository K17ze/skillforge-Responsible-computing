...
const C = {
  ...
  accentLight: '#C4A882', muted: '#9E8E80', border: '#D8CEBD',
  white: '#FFFFFF', tag: '#EDE8DE',
};
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.topBar}>
        ...
        <Text style={styles.topBarSub}>SKILL FORGE</Text>
      </View>
        ...
        <View style={styles.ctaRow}>
          ...
          >
            <Text style={styles.ctaBtnText}>
              {hasSkills ? 'Continue Your Journey' : 'Get Started'}
            </Text>
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  topBarSub: { fontSize: 10, color: C.muted, letterSpacing: 2 },
  container: {
  ...
  heroTagline: {
    fontSize: 36, fontWeight: '300', color: C.bgDark,
    lineHeight: 44, letterSpacing: -0.5,
  },
  arcCardWrapper: { marginBottom: 28 },
  arcCard: {
    backgroundColor: C.bgDark, borderRadius: 20, padding: 22,
  ...
  arcLabel: { color: C.accentLight, fontSize: 11, letterSpacing: 3, fontWeight: '500' },
  arcDate: { color: C.muted, fontSize: 11, letterSpacing: 2 },
  arcShape: {
    width: width * 0.45, height: width * 0.45,
    borderRadius: (width * 0.45) / 2, backgroundColor: C.accent,
    alignSelf: 'center', marginVertical: 8, opacity: 0.85,
  },
  arcBottom: { marginTop: 8 },
  arcBottomTitle: { color: C.white, fontSize: 22, fontWeight: '300', letterSpacing: 0.5 },
  arcBottomSub: { color: C.muted, fontSize: 11, letterSpacing: 2, marginTop: 4 },
  featuresList: { gap: 14, marginBottom: 28 },
  featureRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  featureIndex: { fontSize: 11, color: C.muted, letterSpacing: 1, width: 22 },
  featureDivider: { width: 28, height: 1, backgroundColor: C.border },
  featureText: { fontSize: 14, color: C.bgDark, flex: 1, letterSpacing: 0.2 },
  ctaRow: { gap: 14 },
  ctaBtn: {
    backgroundColor: C.bgDark, paddingVertical: 17,
    borderRadius: 100, alignItems: 'center',
  },
  ctaBtnText: { color: C.white, fontSize: 15, fontWeight: '500', letterSpacing: 1.5 },
  ctaTagRow: {
    flexDirection: 'row', justifyContent: 'center',
    alignItems: 'center', gap: 6,
  },
  ctaTag: { color: C.muted, fontSize: 11, letterSpacing: 0.3 },
  ctaTagDot: { color: C.border },
});
